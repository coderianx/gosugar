# GoSugar İle Test Yazma

GoSugar'ı test yazarken ve test verisi oluştururken nasıl kullanılacağını öğrenin.

## 📋 İçindekiler

- [Test Verisi Oluşturma](#test-verisi-oluşturma)
...
func TestBoolDistribution(t *testing.T) {
    // 1000 kez random boolean üret
    // İstatistiksel olarak ~500 true, ~500 false bekliyoruz
    ...
    // Distribution kontrolü (400-600 arası normal)
...
### Örnek 1: Database Test with Random Data
...
### Örnek 2: Config Validation Test
...
| Kural | Açıklama |
|-------|----------|
| **Deterministic Setup** | Rastgele veri yerine önceden belirlenmiş test data |
| **Cleanup** | defer ile test dosyalarını temizle |
| **Isolation** | Her test bağımsız olmalı |
| **Meaningful Names** | Test adları ne test ettiğini söylemelidir |
| **Edge Cases** | Empty, null, boundary values test et |

---

## İlgili Dosyalar

- [`../api/random.md`](../api/random.md) - Random API referansı
- [`../api/file.md`](../api/file.md) - File API referansı
